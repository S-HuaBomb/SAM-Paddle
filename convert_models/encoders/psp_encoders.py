...
from paddle.nn import Conv2D, BatchNorm2D, PReLU, Sequential, Layer

from convert_models.encoders.helpers import get_blocks, bottleneck_IR, bottleneck_IR_SE
from convert_models.stylegan2.model import EqualLinear
...
class GradualStyleEncoder(Layer):
    ...
    def forward(self, x):
        ...
        out = paddle.stack(latents, axis=1)
        return out
